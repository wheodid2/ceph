...
#ifndef CEPH_MMDSVMapcop_H
#define CEPH_MMDSVMapcop_H
...
class MMDSVMap : public MessageInstance<MMDSVMap, PaxosServiceMessage> {
public:
  friend factory;
private:
...
protected:
  MMDSVMap() : MessageInstance(MSG_MDS_BEACON, 0, HEAD_VERSION, COMPAT_VERSION)
  {
    set_priority(CEPH_MSG_PRIO_HIGH);
  }
  MMDSVMap(const uuid_d &f, mds_gid_t g, const string& n, epoch_t les, MDSMap::DaemonState st, version_t se, uint64_t feat) :
